...
- **chore**: ビルドツールやライブラリで自動生成されたものをコミットする場合や、上記の接頭辞に当てはまらない修正をする場合に使用します。初回コミットは必ずこれを使用します．
```
...
- delete: 〇〇ファイルを削除
- refactor: 不要なコメントを削除
- chore : {パッケージ名}をインストール
- chore : Next.js のインストール
...
- 具体的でわかりやすい内容にする
- 語尾は言い切り
- 初回コミットは「chore: プロジェクトの初期設定」などとする
- feat: プロジェクトの初期設定とファイル追加，など「feat」は不可
