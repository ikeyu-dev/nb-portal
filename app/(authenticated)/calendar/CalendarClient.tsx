...
export default function CalendarClient({
    ...
    useEffect(() => {
        ...
        const cached = serverData
            ? null
            : getClientCacheEntry<CalendarInitialData>(
                  CLIENT_CACHE_KEYS.calendar,
                  CACHE_TTL_MS.pageData
              );

        if (serverData) {
            setClientCache(CLIENT_CACHE_KEYS.calendar, serverData);
        } else if (cached) {
        ...
        const fetchData = async (
            ...
            try {
                ...
                const stale = getStaleClientCacheEntry<CalendarInitialData>(
                    CLIENT_CACHE_KEYS.calendar,
                    {
