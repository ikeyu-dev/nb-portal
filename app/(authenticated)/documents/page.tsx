...
const weatherFlowChart = `flowchart TD
    ...
    A --> B{"降水確率<br/>60%超？"}
    B -->|"☔ 雨予報"| C["🏢 スチュセンで実施<br/>【中規模】"]
    B -->|"☀️ 晴れ予報"| D["🎪 想定通り屋外実施<br/>【大規模】<br/>※スチュセン準備も行う"]
    D --> E{"突然の<br/>降雨？"}
    E -->|"☔ 雨が降り出した"| F{"現在の<br/>状況は？"}
    E -->|"☀️ 問題なし"| G["✅ 通常通り続行"]
    F -->|"🎸 音団ライブ中"| H["🏢 スチュセンに移動<br/>【小規模】"]
    F -->|"🎭 イベント中"| I["🏢 スチュセンに移動<br/>【極小規模】"]
`;
            ...
            <div className="space-y-6">
                ...
                <section>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        <li>
                            雨天トラブル等が予想されるため、スチューデントセンターには小規模編成の機材を準備しておく
                        </li>
                        <li>
                ...
                <section id="pattern-2">
                    ...
                    <p className="mb-4">
                        保護終了後、機材をスチューデントセンターへ移動。使用しないものはNB本部へ移動。
                        雨天用スピーカー・雨天用AMPは、観客がスチューデントセンターへ移動するまでそのままにしておく。
                    </p>
                    ...
                    <p className="mb-2">
                        大学祭側の判断を待ち、スチューデントセンターへ機材を移動。
                        一部の部員は先にスチューデントセンターへ行き準備を行う。
                    </p>
                    <p className="mb-2">
                ...
                <section id="pattern-3">
                    ...
                    <p className="mt-4">
                        並行してスチューデントセンターに必要最低限の機材を搬入・展開。
