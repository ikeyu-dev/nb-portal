    ...
    <div className="max-lg:p-0 lg:p-6 w-full lg:h-full flex flex-col lg:items-stretch items-center bg-base-100 lg:overflow-hidden">
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-auto">
          <table className="table table-zebra table-pin-rows w-full text-sm">
            <thead>
              <tr>
                <th className="bg-base-200 text-base-content">分類</th>
                <th className="bg-base-200 text-base-content">ITEM_ID</th>
                <th className="bg-base-200 text-base-content">NAME</th>
                <th className="bg-base-200 text-base-content">WHEN</th>
              </tr>
            </thead>
            <tbody>
                ...
                filteredItems.map((item, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="font-mono text-xs">{itemId}</td>
                      <td>{name}</td>
      ...
      <div className="hidden lg:flex items-center justify-between mb-4 px-2 w-full">
        <div className="flex items-center gap-2">
          ...
          <span className="badge badge-primary">{filteredItems.length}件</span>
        </div>
                ...
                filteredItems.map((item, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td className="font-mono">{itemId}</td>
                      <td>{name}</td>
                      <td>{when}</td>
                    </tr>
                  );
