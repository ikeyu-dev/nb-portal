/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a0a23a2d71c6b2de240a6e6bbc5a4a0e)
// Runtime types generated with workerd@1.20260611.1 2026-06-12 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	APP_DISCORD_SEND_URL: "https://nb-portal.vercel.app/api/discord-send";
	NEXT_MEETING_ROLE_MENTION: "@部員";
	DISCORD_PUBLIC_KEY: string;
	DISCORD_GUILD_ID: string;
	DISCORD_DEVELOPMENT_GUILD_ID: string;
	DISCORD_PRODUCTION_GUILD_ID: string;
	DISCORD_MEMBER_ROLE_ID: string;
	MEMBER_PROFILE_REFRESH: DurableObjectNamespace<import("./src/index").MemberProfileRefresh>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MemberProfileRefresh";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_DISCORD_SEND_URL" | "NEXT_MEETING_ROLE_MENTION" | "DISCORD_PUBLIC_KEY" | "DISCORD_GUILD_ID" | "DISCORD_DEVELOPMENT_GUILD_ID" | "DISCORD_PRODUCTION_GUILD_ID" | "DISCORD_MEMBER_ROLE_ID">> {}
}
