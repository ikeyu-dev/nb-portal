    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <div className="text-xs text-base-content/60 mb-1">駅発</div>
            {nextFromStation ? (
              <div className="flex items-baseline gap-1">
                <span className="font-bold text-lg">
                  {formatTime(nextFromStation.hour, nextFromStation.minute)}
                </span>
              ...
              <span className="text-sm text-base-content/50">本日終了</span>
            )}
          </div>
          <div>
            <div className="text-xs text-base-content/60 mb-1">大学発</div>
            {nextFromUniversity ? (
              <div className="flex items-baseline gap-1">
                <span className="font-bold text-lg">
                  {formatTime(
