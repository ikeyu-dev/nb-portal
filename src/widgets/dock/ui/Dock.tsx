  ...
  return (
    <>
      ...
      >
        <Link
          href="/home"
          className={`transition-transform ${pathname === "/home" ? "text-primary scale-110" : ""}`}
        >
          <svg
        ...
        <Link
          href="/calendar"
          className={`transition-transform ${pathname === "/calendar" ? "text-primary scale-110" : ""}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
        ...
        <Link
          href="/items"
          className={`transition-transform ${pathname === "/items" ? "text-primary scale-110" : ""}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
        ...
        <Link
          href="/bus"
          className={`transition-transform ${pathname === "/bus" ? "text-primary scale-110" : ""}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
        ...
        <Link
          href="/notifications"
          className={`transition-transform ${pathname === "/notifications" ? "text-primary scale-110" : ""}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 640"
