    ...
    return (
        <div className="dock dock-md fixed bottom-0 left-0 right-0 z-30 lg:hidden">
            <Link href="/home">
                ...
                <span className="dock-label" style={{ fontSize: 'clamp(0.625rem, 2vw, 0.75rem)' }}>Home</span>
            </Link>
            ...
            <Link href="/calendar">
                ...
                <span className="dock-label" style={{ fontSize: 'clamp(0.625rem, 2vw, 0.75rem)' }}>Calendar</span>
            </Link>
            ...
            <Link href="/items">
                ...
                <span className="dock-label" style={{ fontSize: 'clamp(0.625rem, 2vw, 0.75rem)' }}>Items</span>
            </Link>
